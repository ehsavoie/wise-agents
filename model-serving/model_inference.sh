...
$POD_CONTAINER run --rm -it --name local_model -p 8001:8001 -v $MODEL_VOLUME:/locallm/models:ro -e MODEL=/locallm/models/$MODEL_NAME -e HOST=$LLM_BIND_ADDRESS -e PORT=8001 -e MODEL_CHAT_FORMAT=openchat ghcr.io/abetlen/llama-cpp-python:latest
